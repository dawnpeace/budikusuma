<template>
    <div>
        <h5 class="text-center">Edit Arsip Akta Kematian</h5>
        <hr>
        <form @submit.prevent="updateRecord()" class="row" action="" method="post">
            ...
            <div class="col-md-3 col-sm-12">
                <label class="w-100 text-left d-md-none d-lg-none d-sm-block d-xs-block" for="">Wafat Pada</label>
                <label class="w-100 text-right d-none d-md-block d-lg-block d-sm-none d-xs-none" for="">Wafat Pada</label>
            </div>
            <div class="col-md-9 col-sm-12">
                <div class="form-group">
                    <datepicker 
...
export default {
    ...
    data(){
        return {
            ...
            formData : {
                ...
                deceased_at : new Date(this.card.deceased_at)
            },
            disableSubmit : false,
        }
    },
    computed :{
        form(){
            ...
            let deceased_at = cloneDeep(this.formData.deceased_at);
            return {
                ...this.formData,
                birthdate : moment(birthdate).format('DD-MM-YYYY'),
                deceased_at : moment(deceased_at).format('DD-MM-YYYY')
            }
        }
    },
    methods : {
